...
tpwcas_fnc_main_loop = 
{
	...
	while {true} do    
	{
		{ //foreach start
			...
			//if ( (_unitCheck) && (vehicle _x == _x) && (lifestate _x == "ALIVE") && (side _x != civilian) ) then //ARMA3 guerrila 
			//if ( (_unitCheck) && (vehicle _x == _x) && ((lifestate _x == "HEALTHY") || (lifestate _x == "INJURED")) && (side _x != civilian) ) then
			if ( (_unitCheck) && (vehicle _x == _x) && ((lifestate _x == "HEALTHY") || (lifestate _x == "INJURED")) && (side _x != resistance) ) then
			{
				_unit  = _x;
