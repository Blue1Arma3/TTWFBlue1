...
if(gunStoreCart > Tee_Konto) exitWith {hint "You do not have enough money"};
...
switch (_switch) do 
{
	...
	case 0: 
	{
		...
		//player setVariable["Tee_Konto",Tee_Konto - gunStoreCart,true];
		Tee_Konto = Tee_Konto - gunStoreCart;
