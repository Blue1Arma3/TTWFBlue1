...
MANY MANY THANKS to Fred41 for all his effort and help in optimizations!!<br/>
"]];
...
The main target is to capture all towns. At win the Map restarts.<br/>
...
Flag Poles in taken towns are shops too. <br/>
Strategic Mode is ON (you can only take the towns that are next to a already owned one.!!!!<br/>
...
If you get shot by AA in a Heli it shows friendly fire, or cannot open Backpacks or Ammoboxes, thats still an BETA-Bug.<br/>
"]];

player createDiaryRecord ["Diary", ["DONATE and SUPPORT", "DONATE and SUPPORT <br/>
Hi,<br/>
i hope you enjoy the Time on my Servers and having fun with my re-edited Version of Teetimes Warfare.<br/>
I am doing this for fun and as a hobby - but the monthly Serverfee isn't that cheap and regarding to many Feedbacks<br/>
it seems to be one of the best smooth running servers at the moment.<br/>
