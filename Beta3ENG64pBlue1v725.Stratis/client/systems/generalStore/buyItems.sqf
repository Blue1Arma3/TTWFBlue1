...
if(genStoreCart > (player getVariable "Tee_Konto")) exitWith {hint "You do not have enough money"};

//Initialize Values
_playerMoney = player getVariable "Tee_Konto";
_size = 0;
...
player setVariable["Tee_Konto",Tee_Konto - genStoreCart,true];
_playerMoneyText CtrlsetText format["Cash: $%1", player getVariable "Tee_Konto"];
